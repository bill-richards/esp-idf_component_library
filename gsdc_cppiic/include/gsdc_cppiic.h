#ifndef __GSDC_CPPIIC_H__
#define __GSDC_CPPIIC_H__
...
namespace gsdc_cppiic
{
    ...
    public:
        IIC(i2c_port_t port, size_t slv_rx_buf_len = 0, size_t slv_tx_buf_len = 0, int intr_alloc_flags = 0);
        ~IIC();
